        ...
        <div className="w-full lg:w-[30%] p-10 bg-[#19191B] flex justify-center items-center">
          <div className="flex flex-col justify-center">
            ...
            <div>
              ...
              Value Drive is the most trusted way of buying and selling second-hand cars. Choose from more than 100 fully inspected second-hand car models, each undergoing rigorous quality checks. Select online and book a test drive at your home or at a Value Car Hub near you. Every Value Drive car comes with a free one-year comprehensive service warranty and Assured Resale Value guarantee, along with complete transparency about vehicle history and condition
              </p>
            </div>
          </div>
        </div>
